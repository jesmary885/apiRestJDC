            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _this.axios.get("/api/users/".concat(_this.$route.params.id)).then(function (response) {
                  ...
                  _this.user.name = name, _this.user.password = password, _this.user.password_confirmation = password, _this.user.email = email;
              ...
              [
                ...
                _c("div", { staticClass: "w-full mr-2" }, [
                  _c("input", {
                    ...
                    staticClass:
                      "w-full px-2 appearance-none block bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 leading-tight focus:outline-none focus:bg-white focus:border-gray-500",
                    attrs: { type: "text", placeholder: "Confirme contraseña" },
